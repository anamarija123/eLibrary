...
public class AddressController implements Serializable {
    ...
    @EJB
    private hr.ana.library.business.boundary.AddressFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle2").getString("AddressCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle2").getString("AddressUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle2").getString("AddressDeleted"));
        if (!JsfUtil.isValidationFailed()) {
